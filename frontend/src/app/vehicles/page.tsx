    ...
    <div className="min-h-screen bg-luxury-black text-white selection:bg-luxury-gold selection:text-black">
      ...
      <nav className="border-b border-white/10 bg-luxury-black/80 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <span className="text-sm text-luxury-platinum/60 font-medium tracking-wider uppercase">Step 3: Select Vehicle</span>
        </div>
      </nav>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12 text-center">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-white mb-4">
            Your <span className="text-luxury-gold">Dream Garage</span>
          </h1>
          <p className="text-xl text-luxury-platinum/80">
            Browse exclusive inventory within your pre-approved budget.
          </p>
        </div>
        ...
        <div className="mb-16 max-w-3xl mx-auto">
          <div className="flex items-center justify-between relative">
            ...
            <div className="flex flex-col items-center space-y-2 bg-luxury-black px-4">
              ...
              <span className="text-xs font-medium text-luxury-gold uppercase tracking-wider">Lender</span>
            </div>
            ...
            <div className="flex flex-col items-center space-y-2 bg-luxury-black px-4">
              ...
              <span className="text-xs font-medium text-white uppercase tracking-wider">Select Car</span>
            </div>
          </div>
        </div>
